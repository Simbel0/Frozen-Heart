...
function itsRainingPipis:onStart()
    ...
    self.timer:script(function(wait)
        ...
        self.timer:everyInstant(1, function()
            print("pipis")
            self:spawnBullet("neo/pipis", Utils.random(Game.battle.arena.right+20, SCREEN_WIDTH-20), -10, Utils.random(1, 3), math.rad(90), Game:getFlag("first_pipis", true), {y=200})
