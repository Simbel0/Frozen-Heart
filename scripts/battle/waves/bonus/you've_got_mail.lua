...
function you_ve_got_mail:update()
    ...
    elseif self.timer>=40 and self.timer<60 then
        if self.circle then
        ...
        self:spawnBullet("neo/mail", x-(arm.sprite.width+10), y+Utils.random(-9, 9), math.rad(math.deg(Utils.angle(sneo.x, sneo.y, self.soul_pos[1], self.soul_pos[2]))-13), Utils.random(20, 30))
