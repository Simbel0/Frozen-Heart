        ...
        if self.sneo.advance then
            ...
            if self.sneo.deal==1 then
                Game.battle:startCutscene(function(cutscene)
                    ...
                    cutscene:text("* Whatever![wait:5] We ain't gonna get stop by THAT of all things!!", "teeth", "susie")
                end)
                return true
            elseif self.sneo.deal==3 then
                Game.battle:startCutscene(function(cutscene)
                    ...
                    cutscene:text("* Come on![wait:3] If we want to go back to save Noelle, we have to save that guy first.", "angry_c", "susie")
            ...
            elseif self.sneo.deal==5 then
                ...
                Game.battle:startCutscene(function(cutscene)
                    ...
                    cutscene:text("* Kris,[wait:2] maybe we should think of another way before Susie hurt herself...", "smile", "ralsei")
...
function secret_battle:getDialogueCutscene()
    ...
    elseif self.berdly_awoken and (self.berdly.mercy>=90 or self.berdly.fake_health<=self.berdly.max_health/9) then
        return function(cutscene)
            ...
            cutscene:text("* Soon, my genius will serve for an exquisite cause!", "pretencious", "berdly")
            cutscene:text("* Yeah,[wait:2] uh,[wait:2] whatever you say dude.[wait:4] Just let us end the job.", "annoyed", "susie")
            cutscene:text("* Of course, Susan![wait:2] Do not mind my rambeling.[react:1]", "question", "berdly", {reactions={
            ...
            cutscene:text("* Sure[wait:2], but do you think you're reaching out to Kris by killing his friends?", "annoyed", "susie")
            ...
            cutscene:text("* [shake:1]And I have the PERFECT person to accomplish this task.", "crazy-snow", "noelle")
