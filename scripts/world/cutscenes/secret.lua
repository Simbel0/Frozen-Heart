return {
	intro = function(cutscene)
        ...
        cutscene:text("* What's with the silent treatment?", "crazy-scared", "noelle")
        ...
        cutscene:text("* This Room Is Much Colder Than It Should Be.", "true", "queen")
        ...
        cutscene:text("* I Thought Sleeping Would Del This Power Deep Inside Of Her", "pout", "queen")
        queen:setSprite("walk")
        ice_emitter.active = true
        cutscene:text("* But It Seems I Miscalculated", "sorry", "queen")
        ...
        cutscene:look(queen, "down")
        cutscene:text("* Has Your (Organic) Tongue Frozen Up?", "what", "queen")
        cutscene:wait(1)
        ...
        cutscene:text("* When I Noticed That Burghley Stopped Manifesting Around Me", "pout", "queen")
    ...
    intro_2=function(cutscene)
        ...
        cutscene:text("* She became really weird, did you guys do occult stuff or something?", "nervous", "susie")
        ...
        cutscene:text("* But You Have Awakened Too Much", "down_b", "queen")
