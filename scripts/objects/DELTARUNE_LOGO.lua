...
function DELTARUNE:init()
    ...
    self.logo = Assets.getTexture("IMAGE_LOGO")
    self.logo_heart = Assets.getTexture("IMAGE_LOGO")
...
function DELTARUNE:onAddToStage()
    ...
    self.noise = Assets.getSound("kristal_intro")
    self.end_noise = Assets.getSound("kristal_intro_end")
    self.noise:play()
...
function DELTARUNE:draw()
    ...
    if (self.animation_phase == 0) then
        ...
        for i = 0, self.h - 1 do
            ...
            --self:drawSprite(self.logo, (self.x + self.xoff ), (self.y + i), ((1 - self.factor) / 2))
            --self:drawSprite(self.logo, (self.x + self.xoff2 ), (self.y + i), ((1 - self.factor) / 2))
            --self:drawSprite(self.logo, (self.x + self.xoff3 ), (self.y + i), ((1 - self.factor) / 2))
        end
    end
